...
class MNIST():
    def __init__(self, directory = "./"):
        ...
        self.testData = self.normalizeData(testIMG.reshape(testIMG.shape[0], -1))
        #self.testData = testIMG.reshape(testIMG.shape[0], -1)
        ...
        self.validationData = self.normalizeData(validationIMG.reshape(validationIMG.shape[0], -1))
        #self.validationData = validationIMG.reshape(validationIMG.shape[0], -1)
        ...
        self.trainingData = self.normalizeData(trainingIMG.reshape(trainingIMG.shape[0], -1))
        #self.trainingData = trainingIMG.reshape(trainingIMG.shape[0], -1)
